...
const ACCEESS_TOKEN: Secret = env.JWT_SECRET;
...
// Helper function compare a plaintext password with a hashed password
...
export const signAccessToken = (payload: AccessTokenPayload): string => {
  return jwt.sign(payload, ACCEESS_TOKEN, ACCESS_OPTIONS);
};
